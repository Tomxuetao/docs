import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.ca65985f.js";const b=JSON.parse('{"title":"Kubernetes 集群配置","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"views/k8s/cluster-config.md","filePath":"views/k8s/cluster-config.md","lastUpdated":1694081095000}'),e={name:"views/k8s/cluster-config.md"},p=l(`<h1 id="kubernetes-集群配置" tabindex="-1">Kubernetes 集群配置 <a class="header-anchor" href="#kubernetes-集群配置" aria-label="Permalink to &quot;Kubernetes 集群配置&quot;">​</a></h1><p>当创建 Kubernetes 集群时，您可以使用 <a href="./kubekey">KubeKey</a> 去生成含有集群基本信息的配置文件 (config-sample.yaml)。有关配置文件中的 Kubernetes 相关参数，请参阅以下示例。</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#85E89D;">kubernetes</span><span style="color:#E1E4E8;">:</span></span>
