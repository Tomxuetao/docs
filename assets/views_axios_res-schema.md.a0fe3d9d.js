import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.ca65985f.js";const u=JSON.parse('{"title":"响应结构","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"views/axios/res-schema.md","filePath":"views/axios/res-schema.md","lastUpdated":1694601679000}'),l={name:"views/axios/res-schema.md"},e=p(`<h1 id="响应结构" tabindex="-1">响应结构 <a class="header-anchor" href="#响应结构" aria-label="Permalink to &quot;响应结构&quot;">​</a></h1><p>一个请求的响应包含以下信息。</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">{</span></span>
