import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.01af844e.js";const u=JSON.parse('{"title":"基本用例","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"views/axios/example.md","filePath":"views/axios/example.md","lastUpdated":1694589693000}'),p={name:"views/axios/example.md"},o=l(`<h1 id="基本用例" tabindex="-1">基本用例 <a class="header-anchor" href="#基本用例" aria-label="Permalink to &quot;基本用例&quot;">​</a></h1><p>使用axios的基本用例</p><h2 id="commonjs-用法" tabindex="-1">CommonJS 用法 <a class="header-anchor" href="#commonjs-用法" aria-label="Permalink to &quot;CommonJS 用法&quot;">​</a></h2><p>为了在CommonJS中使用 <code>require()</code> 导入时获得TypeScript类型推断（智能感知/自动完成），请使用以下方法：</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">axios</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">require</span><span style="color:#E1E4E8;">(</span><span style="color:#9ECBFF;">&#39;axios&#39;</span><span style="color:#E1E4E8;">).default;</span></span>
